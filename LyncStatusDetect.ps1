...
#Old function used to pause music via arduino, exits
return
...
function HungUp
	...
	$text = '0';
    $text > 'J:\personal_websites\tvpc\public_html\lyncstatus\status.txt';
    '1' > 'J:\personal_websites\tvpc\public_html\lyncstatus\change.txt';
    $global:GEWISCallStatus = 0
    $global:PhoneStatus = 0
...
function IncomingCall ($caller)
    ...
    $text = '1';
    $text > 'J:\personal_websites\tvpc\public_html\lyncstatus\status.txt';
    $caller > 'J:\personal_websites\tvpc\public_html\lyncstatus\caller.txt';
    '1' > 'J:\personal_websites\tvpc\public_html\lyncstatus\change.txt';
    '1' > 'J:\personal_websites\tvpc\public_html\lyncstatus\ringing.txt';
...
$apiPath = "C:\Program Files\Microsoft Office\Office15\LyncSDK\Assemblies\Desktop\Microsoft.Lync.Model.dll"
if (Test-Path $apiPath)
	...
	{
	Write-Error "This script requires the Lync SDK runtime library. The path to this SDK might be wrong in this script" -Category NotInstalled
	break
	}
